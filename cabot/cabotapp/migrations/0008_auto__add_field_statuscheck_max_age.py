...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StatusCheck.max_age'
        db.add_column(u'cabotapp_statuscheck', 'max_age',
                      self.gf('django.db.models.fields.IntegerField')(default=60, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StatusCheck.max_age'
        db.delete_column(u'cabotapp_statuscheck', 'max_age')
    ...
    models = {
        ...
        u'cabotapp.statuscheck': {
            ...
            'max_age': ('django.db.models.fields.IntegerField', [], {'default': '60', 'null': 'True'}),
